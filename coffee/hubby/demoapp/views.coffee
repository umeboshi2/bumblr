define (require, exports, module) ->
  ...
  class ItemActionView extends Backbone.Marionette.ItemView
    template: Templates.short_action

  class ItemActionsView extends Backbone.Marionette.CollectionView
    childView: ItemActionView
    ...
    onDomRefresh: () ->
      ...
      $('.hubby-meeting-item-action-marker').click ->
        ...
        if el.hasClass('itemaction-loaded')
          ...
          response.done =>
            class ActionLayoutView extends Backbone.Marionette.LayoutView
              regions:
                actions: action_area
            layout = new ActionLayoutView
            window.alayout = layout
            #view = new ItemActionsView el:action_area
            view = new ItemActionsView
            view.el = action_area
            view.collection = collection
            window.aview = view
            layout.actions.show(view)
